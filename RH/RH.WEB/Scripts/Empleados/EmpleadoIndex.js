$(document).ready(function () {
    ...
    $("#btnModalRecontratacion2").click(function () {
        
        var empleado = $("input[name='input-inactivos']:checked").val();
     

        window.location.href = "/Empleados/NuevoRegistro/" + empleado;
    });
    ...
    $("#btnTransferEmpresa").click(function () {
        ...
        var idE = $("#tIdEmpresaFiscal").val();
        console.log("F:"+idE);

      var test=   $("#tIdEmpresaFiscal").val();
      console.log(test);

        var idC = $("#tIdEmpresaComplemento").val();
        console.log("C:"+idC);

        var idA = $("#tIdEmpresaAsimilado").val();
        console.log("A:" +idA);

        var idS = $("#tIdEmpresaSindicato").val();
        console.log("S:"+idS);

        var fImss = $("#fechaIMSS").val();
        console.log("imss:"+fImss);
        ...
        $.ajax({
            ...
            data: {
                Empleados: empleados,
                IdEmpresaFiscal: idE,
                IdEmpresaComplemento: idC,
                IdEmpresaSindicato: idS,
                IdEmpresaAsimilado: idA,
                fechaIMSS: fImss
            }
        }).done(function (data) {
